...
export const metadata: Metadata = {
  ...
  description:
    "A manually maintained watchlist of rising Roblox games with online players, like rate, launch window, and opportunity score."
};
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10">
      ...
      <p className="mt-4 max-w-3xl text-gray-600">
        A small, focused watchlist for new and rising Roblox games. Scores are
        editorial placeholders for the first validation cycle.
      </p>
          ...
          <tbody className="divide-y divide-black/10">
            {games.map((game) => (
              <tr key={game.slug}>
                ...
                <td className="px-4 py-4">{game.onlinePlayers.toLocaleString()}</td>
                <td className="px-4 py-4">{game.likeRate}%</td>
                <td className="px-4 py-4">{game.launchWindow}</td>
                <td className="px-4 py-4 font-black">{game.opportunityScore}</td>
