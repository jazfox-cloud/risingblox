  ...
  },
  {
    ...
    guideSections: [
      ...
      },
      {
        ...
        body:
          "The 2026-09-19 official-source check verified three active Scale Slimy Fish code strings. Their exact rewards remain unverified, so keep reward claims cautious until they are confirmed in game.",
        bullets: [
    ...
    guideFaq: [
      ...
      },
      {
        ...
        answer:
          "The 2026-09-19 official-source check verified 10kccu, weather, and turtle as active code strings. See the codes page for the latest source-backed status and cautious reward notes."
      }
    ],
    activeCodes: [
    ...
    codeSections: [
      {
        ...
        bullets: [
          "Primary source: the official Roblox game page and public description checked on 2026-09-19.",
